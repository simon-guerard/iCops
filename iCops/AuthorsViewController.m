...
{
    static NSString *AuthorIdentifier = @"AuthorIdentifier";
    
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:AuthorIdentifier];
    
    if (cell == nil)
        cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:AuthorIdentifier];
