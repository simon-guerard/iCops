...
//    _managedObjectModel = [[NSManagedObjectModel mergedModelFromBundles:nil] retain];
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"iCopsBooksModel" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"iCopsBooks.sqlite"];
    ...
    if (![fileManager fileExistsAtPath:[storeURL path]]) {
        NSURL *defaultStoreURL = [[NSBundle mainBundle] URLForResource:@"iCopsBooks" withExtension:@"sqlite"];
        if (defaultStoreURL) {
